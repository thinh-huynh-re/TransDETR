...
if __name__ == "__main__":
    ...
    #     annotation_path_root ="./exps/e2e_TransVTS_r50_BOVText/preds_3"
    annotation_path_root = "/mmu-ocr/weijiawu/Code/VideoSpotting/PAN_VTS/CoText/outputs/pan_pp_r18_BOVText_desc/xml_spotting"

    frame_path_root = "/share/wuweijia/MyBenchMark/MMVText/BOVTextV2/Test/Frames"
    result_path_cls_root = "./exps/vis_BOVText"
    print(len(os.listdir(annotation_path_root)))
    ...
    for cls in os.listdir(frame_path_root):
        ...
        for i in sequs:
            dic_name.update({"res_" + cls + "_" + i: os.path.join(cls, i)})
    ...
    for seq in os.listdir(annotation_path_root):
        ...
        if "xml" not in seq:
            continue
        # Cls11_Movie_Cls11_Movie_video102.json
        if "Cls16_Government_Cls16_Government_video15" not in seq:
            continue
